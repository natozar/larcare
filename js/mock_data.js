/* =========================================================================
   ...
   Tudo aqui é fictício mas plausível para a praça de Ribeirão Preto:
   bairros, CEPs e coordenadas refletem a cidade. Nomes, valores e
   avaliações são compostos para parecer realistas no interior paulista.
   ========================================================================= */
(function (global) {
  'use strict';

  // ------------------------------------------------------------------
  // Categorias (8) — recorte focado em Ribeirão Preto
  // ------------------------------------------------------------------
  const CATEGORIES = [
    { id: 'eletrica',   name: 'Elétrica',              icon: 'bolt',    blurb: 'Tomadas, lâmpadas, disjuntores' },
    { id: 'hidraulica', name: 'Hidráulica',            icon: 'drop',    blurb: 'Vazamentos, torneiras, descargas' },
    { id: 'ar',         name: 'Ar-condicionado',       icon: 'tv',      blurb: 'Instalação, limpeza, recarga' },
    { id: 'montagem',   name: 'Montagem de móveis',    icon: 'box',     blurb: 'Guarda-roupa, estante, mesa' },
    { id: 'pintura',    name: 'Pintura',               icon: 'brush',   blurb: 'Cômodos, retoques, paredes' },
    { id: 'chaveiro',   name: 'Chaveiro',              icon: 'lock',    blurb: 'Fechaduras, cópias, urgência' },
    { id: 'gas',        name: 'Gás',                   icon: 'flame',   blurb: 'Botijão, registro, instalação' },
    { id: 'faz_tudo',   name: 'Faz-tudo',              icon: 'wrench',  blurb: 'Pequenos consertos diversos' }
  ];
  ...
  // Distâncias mockadas (km) entre o bairro do cliente (Jardim Califórnia)
  // e cada bairro de prestador. Aproximações realistas dentro da praça.
  const DIST_FROM_CLIENT = {
    'Jardim Califórnia':   0.4,
    'Nova Aliança':        2.1,
    'Jardim Botânico':     1.7,
    'Iguatemi':            3.4,
    'Castelo':             3.8,
  ...
  const PROVIDERS = [
    {
      ...
      specialties: [
        ...
        { cat: 'faz_tudo',  years: 9 }
      ],
      bio: 'Eletricista há 15 anos atendendo Ribeirão Preto. Levo ferramenta completa, oriento sobre material antes de comprar e deixo tudo limpo no fim. Formado pelo SENAI e com NR-10 atualizada. Trabalho do Centro até Jardim Paulista, Jardim Califórnia e Ribeirânia.',
      reviews: [
        ...
        { author: 'Felipe S.', rating: 4, text: 'Excelente serviço, só atrasou uns 20 minutos por trânsito. Avisou antes, sem problema.', date: '2026-02-20' },
    ...
    },
    {
      ...
      specialties: [
        ...
        { cat: 'faz_tudo',   years: 18 }
      ],
      bio: 'Vinte e dois anos de hidráulica residencial em Ribeirão e região. Vazamento, troca de torneira, instalação de filtro, reparo em descarga, desentupimento leve. Levo material básico e cobro só o que usar.',
      reviews: [
    ...
    },
    {
      ...
      specialties: [
        ...
        { cat: 'faz_tudo', years: 6 }
      ],
      bio: 'Especialista em montagem de móveis planejados e prontos. Madesa, Tok&Stok, IKEA, Etna, móvel sob medida. Trabalho com manual ou sem, e ajusto nivelamento em piso torto sem reclamar.',
      reviews: [
        { author: 'Letícia F.', rating: 5, text: 'Montou um guarda-roupa Madesa de 6 portas que eu já tinha aberto. Precisou refazer uma parte e nem cobrou diferença.', date: '2026-04-15' },
        { author: 'Henrique B.', rating: 5, text: 'Montou estante, mesa de jantar e cabeceira em uma tarde só. Rápido e bem feito.', date: '2026-04-01' },
    ...
    },
    {
      ...
      reviews: [
        { author: 'Mariana C.', rating: 5, text: 'Pintou o quarto da minha filha em um dia e ficou impecável. Levou fita crepe e proteção do piso.', date: '2026-04-18' },
    ...
    },
    {
      ...
      bio: 'Técnico de ar-condicionado e elétrica. Instalo splits (parte civil + carga), limpo e reviso aparelhos, faço recarga de gás. Levo bucha, parafuso, nível a laser e detector de fuga.',
      reviews: [
        { author: 'Daniel R.', rating: 5, text: 'Split de 12 mil BTUs em parede de drywall. Reforço, suporte, infraestrutura escondida. Ficou impecável.', date: '2026-04-20' },
    ...
    },
    {
      ...
      specialties: [
        { cat: 'chaveiro', years: 16 },
        { cat: 'faz_tudo', years: 6 }
      ],
      bio: 'Chaveira há 16 anos. Atendo Ribeirão e região 24h. Abertura de porta sem dano, troca de segredo, cópia de chave codificada, fechadura tetra, digital e biométrica. Veículo equipado.',
      reviews: [
        { author: 'Cristina A.', rating: 5, text: 'Esqueci a chave dentro de casa às 23h. Márcia veio em 30 minutos, abriu sem arrombar e cobrou exatamente o que combinou no telefone.', date: '2026-04-14' },
        { author: 'Helena S.', rating: 5, text: 'Pontual, organizada, eficiente. Trocou o segredo da porta principal e revisou as outras.', date: '2026-04-02' },
        { author: 'Vinicius D.', rating: 5, text: 'Profissional que atende com seriedade e sem cobrar absurdo na emergência.', date: '2026-03-19' },
        { author: 'Tatiana B.', rating: 4, text: 'Boa profissional. Demorou um pouco para confirmar mas resolveu rápido quando chegou.', date: '2026-03-05' },
    ...
    },
    {
      ...
      specialties: [
        { cat: 'gas',      years: 11 },
        { cat: 'faz_tudo', years: 5 }
      ],
      bio: 'Instalador de gás com 11 anos de experiência. Atendo residencial e comercial em Ribeirão Preto. Botijão, instalação de fogão e cooktop, registro de gás, teste de vazamento com detector. Cadastrado na concessionária.',
      reviews: [
        { author: 'Cecília F.', rating: 5, text: 'Identificou um vazamento no registro de gás que eu não conseguia achar. Trocou peça e fez teste com aparelho. Tranquilizou minha casa inteira.', date: '2026-04-22' },
        ...
        { author: 'Lara P.', rating: 4, text: 'Bom mas demorou para retornar a primeira mensagem. No serviço em si, impecável.', date: '2026-03-23' },
        { author: 'Gabriela M.', rating: 4, text: 'Profissional sério. Combinou preço justo e cumpriu.', date: '2026-03-09' },
    ...
    },
    {
      ...
      specialties: [
        { cat: 'faz_tudo', years: 12 },
        { cat: 'montagem', years: 7 }
      ],
      bio: 'Faz-tudo da zona sul de Ribeirão. Pequenos consertos: dobradiça, fechadura simples, gaveta emperrada, prateleira torta, ralo entupido leve. Combino preço por hora ou por serviço.',
      reviews: [
        { author: 'Eliza S.', rating: 4, text: 'Resolveu três coisas pequenas que estavam pendentes há meses em uma manhã só. Bom para esse tipo de tarefa.', date: '2026-04-11' },
    ...
    },
    {
      ...
      bio: 'Atendo instalação e limpeza de splits. Também faço suportes, varões de cortina e escada articulada. Não levo material, oriento o que comprar antes.',
      reviews: [
    ...
    },
    {
      ...
      specialties: [
        { cat: 'montagem', years: 35 },
        { cat: 'faz_tudo', years: 28 }
      ],
      bio: 'Marceneiro de oficina há 35 anos. Montagem caprichada, conserto de móvel antigo, restauração, dobradiça, gaveta, porta empenada. Trabalho artesanal, prazo combinado, orçamento por escrito.',
      reviews: [
  ...
  // ------------------------------------------------------------------
  // Demandas (10) — todas em Ribeirão Preto
  // ------------------------------------------------------------------
  const DEMANDS = [
    {
      id: 'dem-001',
      ...
      description: 'Comecei notando uma gotinha de manhã, agora está pingando contínuo. Já apertei a base e não resolveu. Pia branca, granito, torneira monocomando que veio com o apartamento (uns 5 anos).',
      neighborhood: 'Jardim Califórnia',
      address_summary: 'Rua Tomé de Souza — Jardim Califórnia',
      urgency: 'ate_3_dias',
      urgency_label: 'Até 3 dias',
      time_pref: 'tarde',
      budget_min: 100, budget_max: 280,
      photos: 2,
      published_at_iso: '2026-05-14T09:42:00',
    ...
    },
    {
      ...
      description: 'Comprei o split novo (Samsung WindFree), tem o suporte da parede pronto e o ponto elétrico de 220V. Falta apenas furar a parede para a tubulação e instalar. Apartamento em segundo andar, sem necessidade de plataforma.',
      neighborhood: 'Jardim Califórnia',
      address_summary: 'Rua Tomé de Souza — Jardim Califórnia',
      urgency: 'ate_7_dias',
      urgency_label: 'Até 7 dias',
      time_pref: 'qualquer',
      budget_min: 280, budget_max: 480,
      photos: 1,
      published_at_iso: '2026-05-12T15:20:00',
    ...
    },
    {
      ...
      photos: 0,
      published_at_iso: '2026-05-14T08:10:00',
    ...
    },
    {
      ...
      neighborhood: 'Ribeirânia',
      address_summary: 'Rua Lafaiete — Ribeirânia',
      urgency: 'ate_3_dias',
      urgency_label: 'Até 3 dias',
      time_pref: 'tarde',
      budget_min: 120, budget_max: 250,
      photos: 1,
      published_at_iso: '2026-05-14T07:30:00',
    ...
    },
    {
      ...
      neighborhood: 'Iguatemi',
      address_summary: 'Rua Pio XI — Iguatemi',
      urgency: 'sem_pressa',
      urgency_label: 'Sem pressa',
      time_pref: 'qualquer',
      budget_min: 280, budget_max: 600,
      photos: 2,
      published_at_iso: '2026-05-13T11:45:00',
    ...
    },
    {
      ...
      neighborhood: 'Sumarezinho',
      address_summary: 'Avenida Independência — Sumarezinho',
      urgency: 'ate_3_dias',
      urgency_label: 'Até 3 dias',
      time_pref: 'manha',
      budget_min: 80, budget_max: 180,
      photos: 1,
      published_at_iso: '2026-05-14T06:15:00',
    ...
    },
    {
      ...
      neighborhood: 'Vila Tibério',
      address_summary: 'Rua Saldanha Marinho — Vila Tibério',
      urgency: 'ate_7_dias',
      urgency_label: 'Até 7 dias',
      time_pref: 'qualquer',
      budget_min: 250, budget_max: 450,
      photos: 0,
      published_at_iso: '2026-05-13T17:30:00',
    ...
    },
    {
      ...
      description: 'Tenho cheiro forte de gás na cozinha quando uso o fogão. Já fechei o registro principal. Preciso de alguém com detector para identificar o vazamento e trocar o que estiver com defeito. Apartamento em quinto andar.',
      neighborhood: 'Alto da Boa Vista',
      address_summary: 'Rua Tibiriçá — Alto da Boa Vista',
      urgency: 'hoje',
      urgency_label: 'Hoje',
      time_pref: 'manha',
      budget_min: 120, budget_max: 280,
      photos: 1,
      published_at_iso: '2026-05-13T09:15:00',
    ...
    },
    {
      ...
      neighborhood: 'Nova Aliança',
      address_summary: 'Rua Tabajaras — Nova Aliança',
      urgency: 'ate_3_dias',
      urgency_label: 'Até 3 dias',
      time_pref: 'tarde',
      budget_min: 80, budget_max: 160,
      photos: 0,
      published_at_iso: '2026-05-14T10:05:00',
    ...
    },
    {
      ...
      neighborhood: 'Jardim Paulista',
      address_summary: 'Rua Carlos Adami — Jardim Paulista',
      urgency: 'hoje',
      urgency_label: 'Hoje',
      time_pref: 'qualquer',
      budget_min: 100, budget_max: 250,
      photos: 0,
      published_at_iso: '2026-05-14T11:55:00',
  ...
  // ------------------------------------------------------------------
  // Propostas (43) — pelo menos 4 na demanda destaque (dem-001)
  // ------------------------------------------------------------------
  const PROPOSALS = [
    // dem-001 — 4 propostas variadas
    { id: 'prop-001-a', demand_id: 'dem-001', provider_id: 'pro-002', value: 180, time_estimate: '1 hora', availability_text: 'Posso passar hoje à tarde, entre 14h e 17h',
    ...
    { id: 'prop-001-b', demand_id: 'dem-001', provider_id: 'pro-005', value: 140, time_estimate: '1h30', availability_text: 'Hoje a partir das 18h ou amanhã 9h',
    ...
    { id: 'prop-001-c', demand_id: 'dem-001', provider_id: 'pro-009', value: 95, time_estimate: '45 minutos', availability_text: 'Amanhã à tarde',
    ...
    { id: 'prop-001-d', demand_id: 'dem-001', provider_id: 'pro-001', value: 220, time_estimate: '1 hora', availability_text: 'Hoje 16h ou amanhã 10h',
    ...
    { id: 'prop-002-a', demand_id: 'dem-002', provider_id: 'pro-006', value: 380, time_estimate: '2h30', availability_text: 'Sábado de manhã',
      message: 'Levo bomba de vácuo, manômetro e bucha adequada. Instalação completa com teste de carga e isolamento.',
      sent_minutes_ago: 60*48, status: 'accepted' },
    { id: 'prop-002-b', demand_id: 'dem-002', provider_id: 'pro-011', value: 320, time_estimate: '2h', availability_text: 'Quinta à tarde',
      message: 'Faço split rápido. Levo nível e furadeira de impacto.',
      sent_minutes_ago: 60*47, status: 'rejected' },
    { id: 'prop-002-c', demand_id: 'dem-002', provider_id: 'pro-001', value: 410, time_estimate: '2h30', availability_text: 'Quando combinarmos',
      message: 'Faço a parte elétrica também se precisar de revisão. Garantia de 30 dias.',
      sent_minutes_ago: 60*46, status: 'rejected' },
    { id: 'prop-002-d', demand_id: 'dem-002', provider_id: 'pro-005', value: 360, time_estimate: '3h', availability_text: 'Quarta à tarde',
      message: 'Faço sem pressa, sem improviso. Levo todo material elétrico.',
      sent_minutes_ago: 60*45, status: 'rejected' },
    { id: 'prop-002-e', demand_id: 'dem-002', provider_id: 'pro-009', value: 290, time_estimate: '3h', availability_text: 'Sábado ou domingo',
      message: 'Atendo aos finais de semana. Trago furadeira boa.',
      sent_minutes_ago: 60*44, status: 'rejected' },
    { id: 'prop-002-f', demand_id: 'dem-002', provider_id: 'pro-008', value: 350, time_estimate: '2h', availability_text: 'Quinta de manhã',
      message: 'Tenho experiência com split de embutir e dreno especial.',
      sent_minutes_ago: 60*43, status: 'rejected' },

    // dem-003 — 3 propostas
    { id: 'prop-003-a', demand_id: 'dem-003', provider_id: 'pro-001', value: 110, time_estimate: '40 min', availability_text: 'Hoje à noite, 19h-21h',
      message: 'Posso passar hoje à noite. Levo lâmpada led e soquete novo se precisar trocar.',
      sent_minutes_ago: 80, status: 'pending' },
    { id: 'prop-003-b', demand_id: 'dem-003', provider_id: 'pro-005', value: 85, time_estimate: '30 min', availability_text: 'Amanhã 9h',
      message: 'Não atendo à noite, mas posso passar cedo amanhã.',
      sent_minutes_ago: 65, status: 'pending' },
    { id: 'prop-003-c', demand_id: 'dem-003', provider_id: 'pro-006', value: 130, time_estimate: '30 min', availability_text: 'Hoje 20h',
      message: 'Tenho escada para 4 m. Resolvo na noite.',
      sent_minutes_ago: 30, status: 'pending' },

    // dem-004 — 2
    { id: 'prop-004-a', demand_id: 'dem-004', provider_id: 'pro-006', value: 180, time_estimate: '1h', availability_text: 'Amanhã à tarde',
      message: 'TV grande em drywall pede reforço. Levo barra de fixação.',
      sent_minutes_ago: 90, status: 'pending' },
    { id: 'prop-004-b', demand_id: 'dem-004', provider_id: 'pro-011', value: 150, time_estimate: '1h', availability_text: 'Domingo',
      message: 'Atendo Ribeirânia. Levo nível e parafusos compatíveis.',
      sent_minutes_ago: 70, status: 'pending' },

    // dem-005 — 5
    { id: 'prop-005-a', demand_id: 'dem-005', provider_id: 'pro-004', value: 380, time_estimate: '1 dia', availability_text: 'Próxima semana, qualquer dia',
      message: 'Quarto pequeno, 1 dia inteiro. Cubro tudo, levo fita crepe e proteção do piso. Tinta lavável seca rápido.',
      sent_minutes_ago: 60*8, status: 'pending' },
    { id: 'prop-005-b', demand_id: 'dem-005', provider_id: 'pro-010', value: 420, time_estimate: '1 dia', availability_text: 'Quinta ou sexta',
      message: 'Trabalho com a casa habitada, sem cheiro forte. Cubro mobiliário restante. Acabamento fino.',
      sent_minutes_ago: 60*6, status: 'pending' },
    { id: 'prop-005-c', demand_id: 'dem-005', provider_id: 'pro-001', value: 350, time_estimate: '1 dia', availability_text: 'Segunda',
      message: 'Faço pintura simples também. Combino preço fixo.',
      sent_minutes_ago: 60*5, status: 'pending' },
    { id: 'prop-005-d', demand_id: 'dem-005', provider_id: 'pro-005', value: 320, time_estimate: '1 dia + retoque', availability_text: 'Esta semana',
      message: 'Posso fazer com retoque grátis em até 30 dias.',
      sent_minutes_ago: 60*4, status: 'pending' },
    { id: 'prop-005-e', demand_id: 'dem-005', provider_id: 'pro-009', value: 280, time_estimate: '1,5 dias', availability_text: 'Sábado',
      message: 'Trabalho cuidadoso, cobro hora.',
      sent_minutes_ago: 60*2, status: 'pending' },

    // dem-006 — 3
    { id: 'prop-006-a', demand_id: 'dem-006', provider_id: 'pro-002', value: 110, time_estimate: '40 min', availability_text: 'Amanhã 9h',
      message: 'Bom que já comprou a torneira. Levo conexão extra caso a antiga tenha danificado o ladrão.',
      sent_minutes_ago: 200, status: 'pending' },
    { id: 'prop-006-b', demand_id: 'dem-006', provider_id: 'pro-005', value: 95, time_estimate: '30 min', availability_text: 'Amanhã 8h',
      message: 'Trabalho rápido nesse tipo de troca.',
      sent_minutes_ago: 180, status: 'pending' },
    { id: 'prop-006-c', demand_id: 'dem-006', provider_id: 'pro-009', value: 130, time_estimate: '40 min', availability_text: 'Hoje à tarde',
      message: 'Atendo Sumarezinho hoje mesmo se topar.',
      sent_minutes_ago: 120, status: 'pending' },

    // dem-007 — 4
    { id: 'prop-007-a', demand_id: 'dem-007', provider_id: 'pro-003', value: 320, time_estimate: '4-5 horas', availability_text: 'Sábado 9h',
      message: 'Madesa 6 portas eu faço com olhos fechados. Levo nível e calços. Piso inclinado resolvido com pé regulador.',
      sent_minutes_ago: 60*8, status: 'pending' },
    { id: 'prop-007-b', demand_id: 'dem-007', provider_id: 'pro-012', value: 380, time_estimate: '5 horas', availability_text: 'Próxima quarta',
      message: 'Trabalho cuidadoso, sem riscos. Reviso fechaduras e dobradiças no fim.',
      sent_minutes_ago: 60*6, status: 'pending' },
    { id: 'prop-007-c', demand_id: 'dem-007', provider_id: 'pro-009', value: 280, time_estimate: '5-6 horas', availability_text: 'Domingo',
      message: 'Faço aos finais de semana.',
      sent_minutes_ago: 60*4, status: 'pending' },
    { id: 'prop-007-d', demand_id: 'dem-007', provider_id: 'pro-011', value: 260, time_estimate: '5 horas', availability_text: 'Sábado à tarde',
      message: 'Atendo Vila Tibério. Combine antes a logística do quarto.',
      sent_minutes_ago: 60*2, status: 'pending' },

    // dem-008 — 2 (gás urgente)
    { id: 'prop-008-a', demand_id: 'dem-008', provider_id: 'pro-008', value: 220, time_estimate: '1h', availability_text: 'Posso ir em até 1 hora',
      message: 'Atendo emergência de gás em Ribeirão. Levo detector eletrônico e peças básicas de reposição. Faço teste pneumático antes de liberar.',
      sent_minutes_ago: 60*15, status: 'pending' },
    { id: 'prop-008-b', demand_id: 'dem-008', provider_id: 'pro-005', value: 180, time_estimate: '1h30', availability_text: 'Hoje à tarde',
      message: 'Identifico o ponto de vazamento e troco a peça defeituosa. Faço gás faz uns 12 anos.',
      sent_minutes_ago: 60*8, status: 'pending' },

    // dem-009 — 3
    { id: 'prop-009-a', demand_id: 'dem-009', provider_id: 'pro-006', value: 120, time_estimate: '40 min', availability_text: 'Hoje à tarde',
      message: 'Furadeira de impacto Bosch. 8 furos em alvenaria são rápidos. Levo bucha de 8 mm.',
      sent_minutes_ago: 4, status: 'pending' },
    { id: 'prop-009-b', demand_id: 'dem-009', provider_id: 'pro-001', value: 95, time_estimate: '30 min', availability_text: 'Hoje 15h-17h',
      message: 'Atendo Nova Aliança hoje mesmo. Levo furadeira SDS, broca widia e buchas de 8 mm. Sem volta à loja.',
      sent_minutes_ago: 12, status: 'pending' },
    { id: 'prop-009-c', demand_id: 'dem-009', provider_id: 'pro-005', value: 140, time_estimate: '45 min', availability_text: 'Amanhã pela manhã',
      message: 'Posso passar amanhã se topar. Trago tudo que precisa, inclusive nivelamento dos furos.',
      sent_minutes_ago: 22, status: 'pending' },

    // dem-010 — 4 (chaveiro urgente)
    { id: 'prop-010-a', demand_id: 'dem-010', provider_id: 'pro-007', value: 180, time_estimate: '40 min', availability_text: 'Posso ir agora, em 30 min',
      message: 'Atendo Jardim Paulista, posso sair agora. Levo cilindro de reserva. Sem arrombar a porta.',
      sent_minutes_ago: 1, status: 'pending' },
    { id: 'prop-010-b', demand_id: 'dem-010', provider_id: 'pro-001', value: 220, time_estimate: '1 hora', availability_text: 'Em 1 hora',
      message: 'Posso passar em 1 hora, levo conjunto Yale e Stam de reserva. Garantia de 30 dias.',
      sent_minutes_ago: 1, status: 'pending' },
    { id: 'prop-010-c', demand_id: 'dem-010', provider_id: 'pro-009', value: 150, time_estimate: '30 min', availability_text: 'Amanhã 7h antes da viagem',
      message: 'Posso passar amanhã bem cedinho, antes da sua viagem. Conserto rápido.',
      sent_minutes_ago: 0.5, status: 'pending' },
    { id: 'prop-010-d', demand_id: 'dem-010', provider_id: 'pro-005', value: 130, time_estimate: '40 min', availability_text: 'Hoje à noite',
      message: 'Atendo até as 22h hoje. Cilindro novo + lubrificação completa.',
      sent_minutes_ago: 0.2, status: 'pending' }
  ];
  ...
  global.LarCareData = {
    CATEGORIES, PROVIDERS, DEMANDS, PROPOSALS, DEMO_CLIENT, CLIENT_HISTORY, NEIGHBORHOODS,
